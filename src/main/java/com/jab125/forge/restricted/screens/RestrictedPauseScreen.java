...
@OnlyIn(Dist.CLIENT)
public class RestrictedPauseScreen extends Screen {
    ...
    public RestrictedPauseScreen(boolean p_96308_) {
    ...
    private void createPauseMenu() {
        ...
        Button button = this.addRenderableWidget(new Button(this.width / 2 + 4, this.height / 4 + 96 + -16, 98, 20, new TranslatableComponent("menu.comingSoon"), (p_96321_) -> {
