...
@OnlyIn(Dist.CLIENT)
public class RestrictedTitleScreen extends Screen {
    ...
    public RestrictedTitleScreen() {
        this(false);
    }

    public RestrictedTitleScreen(boolean p_96733_) {
    ...
    public void render(PoseStack p_96739_, int p_96740_, int p_96741_, float p_96742_) {
        ...
        if ((l & -67108864) != 0) {
            ...
            renderMainMenu(this, p_96739_, this.font, this.width, this.height, l);
            if (this.splash != null) {
                p_96739_.pushPose();
    ...
    public static NotificationModUpdateScreen init(RestrictedTitleScreen guiMainMenu, Button modButton)
    {
    ...
    public static void renderMainMenu(RestrictedTitleScreen gui, PoseStack mStack, Font font, int width, int height, int alpha)
    {
